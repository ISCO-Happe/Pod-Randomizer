...
class MTGPodRandomizer {
    ...
    updateConfig() {
        this.config.default_pod_size = Math.max(3, Math.min(5, parseInt(this.targetSizeInput.value) || 4));
        this.config.max_pod_size = Math.max(3, Math.min(5, parseInt(this.maxSizeInput.value) || 5));
